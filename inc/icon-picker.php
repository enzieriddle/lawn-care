...
class Lawn_Care_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'lawn-care' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $lawn_care_font_awesome_icon_array = lawn_care_font_awesome_icon_array();
                    foreach ($lawn_care_font_awesome_icon_array as $lawn_care_font_awesome_icon) {
                            $icon_class = $this->value() == $lawn_care_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($lawn_care_font_awesome_icon).'"></i>
                            <span class="lawn-care-social-class">'.esc_attr($lawn_care_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function lawn_care_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'lawn-care-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'lawn_care_customizer_script' );

if(!function_exists('lawn_care_font_awesome_icon_array')){
    function lawn_care_font_awesome_icon_array(){
